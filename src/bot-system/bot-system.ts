...
export class BotSystem extends Unit {
    ...
    private instanceName: string // bot name with instance id
    private startDateStr: string // string date of the botSystem start
    private propBotSystemState: Prop<BotSystemState> // indicate the state of the bot system
    private propSaveDirPath: Prop<String> // path to the save directory

    
    /** Bot System Components */
    private interfaceApiManager: InterfaceApiManager
    private componentManager: ComponentManager  // manage the components
