...
export class SaveController<DataType> {
    private dataToSave: DataType
    private saveInterface: SaveInterface

    private nbSaveAsked: number
    private nbAskToSave: number
    private saveCooldown: number // in ms
    private saveAfterAskTime: number // in ms
    private hasCurrentTimeoutSave: boolean
